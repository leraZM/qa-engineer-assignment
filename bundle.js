  ...
  function (e, t, n) {
    ...
    function c(e) {
      ...
      return (
        ...
        (i.childContextTypes = (((t = {})[e] = u.isRequired), (t[n] = a), t)),
        i
      );
    }
    var s = c();
          ...
          a = (function (n) {
            ...
            return (
              ...
              (u.addExtraProps = function (e) {
                if (!(N || S || (this.propsMode && this.subscription)))
                  return e;
                var t = d({}, e);
                return (
    ...
    function P(e, t) {
      ...
      for (var o = 0; o < n.length; o++)
        if (!x.call(t, n[o]) || !_(e[n[o]], t[n[o]])) return !1;
      return !0;
    }
    var C = n(2);
    function O(e) {
    ...
    var q,
      ...
      J,
      Z =
        (($ = (Q = void 0 === q ? {} : q).connectHOC),
        (W = void 0 === $ ? S : $),
        (V = Q.mapStateToPropsFactories),
        (H = void 0 === V ? j : V),
        (B = Q.mapDispatchToPropsFactories),
        (K = void 0 === B ? R : B),
        (Y = Q.mergePropsFactories),
        (X = void 0 === Y ? z : Y),
        (G = Q.selectorFactory),
        (J = void 0 === G ? L : G),
        function (e, t, n, r) {
          ...
          var o = r,
            ...
            b = A(e, H, 'mapStateToProps'),
            g = A(t, K, 'mapDispatchToProps'),
            w = A(n, X, 'mergeProps');
          return W(
            J,
            d(
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    var u = (function (e) {
      function t(e) {
        ...
        return (
          (n.state = { show: !1 }),
          (n.handleShow = n.handleShow.bind(n)),
            ...
            value: function () {
              return i.default.createElement(
                ...
                i.default.createElement(
                  ...
                  {
                    className:
                      'tooltipped-title__tooltip ' +
                      (this.state.show ? '' : 'hidden-xl-down'),
                  },
                  this.props.tooltip,
                ),
              );
    ...
    (u.propTypes = {
      ...
      tooltip: l.default.string.isRequired,
    }),
      (t.default = u);
  },
  function (e, t, n) {
    ...
    o.default.render(
      r.default.createElement(
        i.Provider,
        {
          store: d(
            s.default,
            (0, u.composeWithDevTools)((0, l.applyMiddleware)(a.default)),
          ),
        },
  ...
  function (e, t, n) {
      ...
      (null !== o
        ...
        r || null === o
          ? (function (e) {
              return (
                !!$.call(V, e) ||
                (!$.call(W, e) && (Q.test(e) ? (V[e] = !0) : ((W[e] = !0), !1)))
              );
            })(t) &&
    ...
    function Gt(e, t, n, r) {
      if (Ht)
        if (0 < gt.length && -1 < _t.indexOf(e))
          ...
          var o = Jt(e, t, n, r);
          if (null === o) Ot(e, r);
          else if (-1 < _t.indexOf(e)) (e = Ct(o, e, t, n, r)), gt.push(e);
          else if (
            !(function (e, t, n, r, o) {
              switch (t) {
                case 'focus':
    ...
    function fr(e, t, n) {
      return (
        ((e = Wn.getPooled(sr.change, e, t, n)).type = 'change'), R(n), Fn(e), e
      );
    }
    var dr = null,
      pr = null;
      ...
      return Vr || null == Qr || Qr !== sn(n)
        ...
        : ('selectionStart' in (n = Qr) && hn(n)
          ...
          Wr && Ar(Wr, n)
            ? null
            : ((Wr = n),
              ((e = Wn.getPooled(qr.select, $r, e, t)).type = 'select'),
              (e.target = Qr),
              Fn(e),
              e));
    }
        ...
        do {
          ...
          if (s < qi) {
            ...
            null === u ? ((a = u = f), (i = r)) : (u = u.next = f),
              s > Qi.expirationTime && ((Qi.expirationTime = s), lu(s));
          } else
            null !== u &&
              (u = u.next =
                {
    ...
    function ol(e, t, n, r) {
      ...
      if (null !== $i) {
        ...
        if (((i = l.destroy), null !== r && Bi(r, l.deps)))
    ...
    function ml(e, t, n) {
      ...
      if (
        ...
        (Vi = !0), (o.expirationTime = qi), (Qi.expirationTime = qi);
      else {
        if (
          0 === e.expirationTime &&
    ...
    function Rl(e, t, n, r, o) {
      ...
      return (
        ...
        (r = Ki(e, t, n, r, i, o)),
        null === e || Nl
          ? ((t.effectTag |= 1), Ml(e, t, r, o), t.child)
    ...
    function Dl(e, t, n, r, o) {
      ...
      return (
        ...
        (n = Ki(e, t, n, r, i, o)),
        null === e || Nl
          ? ((t.effectTag |= 1), Ml(e, t, n, o), t.child)
          : ((t.updateQueue = e.updateQueue),
            (t.effectTag &= -517),
            e.expirationTime <= o && (e.expirationTime = 0),
            Kl(e, t, o))
    ...
    function Bl(e, t, n) {
      var r = t.pendingProps,
        o = r.revealOrder,
        i = r.tail;
      if ((Ml(e, t, r.children, n), 0 != (2 & (r = Di.current))))
              ...
              : ((n = null !== r),
                ...
                n &&
                  ...
                  0 != (1 & Di.current)
                    ? Pa === wa && (Pa = Ea)
                    : ((Pa !== wa && Pa !== Ea) || (Pa = ka),
                      0 !== Ra && null !== Sa && (ju(Sa, _a), Iu(Sa, Ra)))),
                (n || r) && (t.effectTag |= 4),
                null)
          );
        case 4:
    ...
    function Ya(e, t) {
      ...
      return (
        null !== o && (Sa === o && (lu(t), Pa === ka && ju(o, _a)), Iu(o, t)), o
      );
    }
    function Xa(e) {
    ...
    function Ga(e) {
      if (0 !== e.lastExpiredTime)
        (e.callbackExpirationTime = 1073741823),
          ...
          (e.callbackNode = Vo(Za.bind(null, e)));
      else {
        var t = Xa(e),
          n = e.callbackNode;
        if (0 === t)
    ...
    function Ja(e, t) {
      ...
      if (0 !== n) {
        ...
        if ((mu(), (e === Sa && n === _a) || nu(e, n), null !== xa)) {
          ...
          if ((ei(), (Ta = r), (ba.current = o), 1 === Pa))
            throw ((t = Ca), nu(e, n), ju(e, n), Ga(e), t);
          if (null === xa)
            switch (
    ...
    function Za(e) {
      ...
      if ((mu(), (e === Sa && t === _a) || nu(e, t), null !== xa)) {
        ...
        if ((ei(), (Ta = n), (ba.current = r), 1 === Pa))
          throw ((n = Ca), nu(e, t), ju(e, t), Ga(e), n);
    ...
    function nu(e, t) {
      ...
      if ((-1 !== n && ((e.timeoutHandle = -1), wn(n)), null !== xa))
    ...
    function su(e) {
      ...
      do {
        ...
        if (((e = xa.return), 0 == (2048 & xa.effectTag))) {
          ...
          null !== e &&
            0 == (2048 & e.effectTag) &&
            (null === e.firstEffect && (e.firstEffect = xa.firstEffect),
            null !== xa.lastEffect &&
              (null !== e.lastEffect &&
                (e.lastEffect.nextEffect = xa.firstEffect),
              (e.lastEffect = xa.lastEffect)),
            1 < xa.effectTag &&
              (null !== e.lastEffect
                ? (e.lastEffect.nextEffect = xa)
                : (e.firstEffect = xa),
              (e.lastEffect = xa)));
        } else {
    ...
    function gu(e, t, n) {
      ...
      null !== r && r.delete(t),
        Sa === e && _a === n
          ? Pa === ka || (Pa === Ea && 1073741823 === Oa && Uo() - Ia < 500)
            ? nu(e, _a)
            : (ja = !0)
          : Ru(e, n) &&
    ...
    ya = function (e, t, n) {
      ...
      if (null !== e) {
        ...
        if (e.memoizedProps !== o || po.current) Nl = !0;
        else {
          if (r < n) {
            switch (((Nl = !1), t.tag)) {
              case 3:
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 4:
          return (
            Ri(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            null === e ? (t.child = xi(t, null, r, n)) : Ml(e, t, r, n),
            t.child
          );
        case 11:
          return (
            (r = t.type),
            (o = t.pendingProps),
            Rl(e, t, r, (o = t.elementType === r ? o : Yo(r, o)), n)
          );
        case 7:
      ...
      try {
        for (
          ...
          if (null !== a) {
            ...
            (n = t.unstable_now()),
              'function' == typeof u ? (R.callback = u) : R === _(O) && P(O),
              F(n);
          } else P(O);
          R = _(O);
        }
      ...
      (t.unstable_scheduleCallback = function (e, n, l) {
        ...
        return (
          ...
          u > a
            ? ((e.sortIndex = u),
              x(N, e),
              null === _(O) && e === _(N) && (D ? i() : (D = !0), o(L, u - a)))
            : ((e.sortIndex = l), x(O, e), z || I || ((z = !0), r(A))),
          e
        );
      }),
        ...
        o(t, [
          {
            ...
            value: function () {
              return l.default.createElement(
                'header',
                { className: 'header' },
                l.default.createElement('h1', null, 'The awesome Q/A tool'),
              );
            },
          },
        ]),
  ...
  function (e, t, n) {
    ...
    var d = (function (e) {
      function t(e) {
        ...
        return (
          (n.handleRemoveQuestions = n.handleRemoveQuestions.bind(n)),
          (n.handleSortQuestions = n.handleSortQuestions.bind(n)),
          n
        );
      }
      return (
        ...
        r(t, [
          {
            key: 'handleRemoveQuestions',
            value: function () {
              this.props.dispatch((0, s.removeQuestions)());
            },
          },
          {
            key: 'handleSortQuestions',
            value: function () {
    ...
    (d.propTypes = { questions: a.default.array.isRequired }),
      (t.default = (0, l.connect)()(d));
  },
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    ...
    var u = (function (e) {
      function t(e) {
        ...
        return (
          (n.state = { show: !1 }),
          (n.handleToggleShow = n.handleToggleShow.bind(n)),
          n
        );
      }
      return (
      ...
      function t() {
        ...
        return (
          ...
          (r.handleSubmitQuestion = function (e) {
            e.preventDefault(),
              r.props.dispatch(
                (0, u.addQuestion)(r.state.question, r.state.answer),
              ),
              r.setState({ question: '', answer: '' });
          }),
          f(r, n)
        );
      }
        ...
        r(t, [
          {
            ...
            value: function () {
              return i.default.createElement(
                ...
                i.default.createElement(
                  'form',
                  { className: 'form', onSubmit: this.handleSubmitQuestion },
                  i.default.createElement(
                    'div',
  ...
  function (e, t, n) {
    ...
    (s.propTypes = { numberOfQuestions: l.default.number.isRequired }),
      (t.default = s);
  },
  function (e, t, n) {
    'use strict';
      ...
      switch (t.type) {
        ...
        case 'SORT_QUESTIONS':
          return e.slice().sort(function (e, t) {
            return e.question.toLowerCase() < t.question.toLowerCase()
              ? -1
              : e.question.toLowerCase() > t.question.toLowerCase()
                ? 1
                : 0;
          });
        default:
